...
<div class="container">
    <form class="row pt-4" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" name="phone_number" class="form-control" id="input1" required>
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="input1" class="col-sm-2 control-label">Confirmer le mot de passe</label>
            <div class="col-sm-10">
                <input type="password" name="password_confirmation" class="form-control" id="input1" required>
            </div>
        </div>
        ...
        <div class="pt-4">
            ...
            <a href="espaceAdmin">
                <button class="btn btn-success m-3">Voir la liste</button>
            </a>
        </div>
    </form>
</div>
